  ...
  return (
    ...
    <main className="min-h-screen w-screen ">
      ...
      <div className="justify-items-center lg:mx-32 mx-4 items-center -mt-20 drop-shadow-lg bg-zinc-50 rounded grid lg:grid-cols-4 grid-flow-row z-40">
        <div className="p-6 flex flex-col space-y-4   lg:border-r border-zinc-600">
        ...
        <div className="p-6 flex flex-col space-y-4 my-10  lg:border-r border-zinc-600">
        ...
        <div className="p-6 flex flex-col space-y-4 my-10  lg:border-r border-zinc-600">
          ...
          <p>
            ...
            acquisition for you while making you free to focus on your long term
            corporate goals.
          </p>
        </div>
        <div className="p-6 flex flex-col space-y-4 my-10">
